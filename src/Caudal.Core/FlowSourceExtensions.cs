...
public static class FlowSourceExtensions
{
    ...
    public static Flow<T> ToFlow<T>(this IAsyncEnumerable<T> source, FlowOptions? options = null)
        => Flow.From(source, options);

    /// <summary>Creates a flow from an async sequence with an explicit buffer capacity.</summary>
    public static Flow<T> ToFlow<T>(this IAsyncEnumerable<T> source, int capacity, string? name = null)
    ...
    public static Flow<T> ToFlow<T>(this IEnumerable<T> source, FlowOptions? options = null)
    {
    ...
    public static Flow<T> ToFlow<T>(this IEnumerable<T> source, int capacity, string? name = null)
    {
        ArgumentNullException.ThrowIfNull(source);
    ...
    public static Flow<T> ToFlow<T>(this ChannelReader<T> reader, FlowOptions? options = null)
    {
    ...
    public static Flow<T> ToFlow<T>(this ChannelReader<T> reader, int capacity, string? name = null)
    {
        ArgumentNullException.ThrowIfNull(reader);
